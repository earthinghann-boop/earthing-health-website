...
// Find the section divider close tag (right before the <!-- Footer -->)
var marker = '</section>\n\n\n\n<!-- Footer -->';
var idx = h.indexOf(marker);
console.log('divider close idx:', idx);
if (idx === -1) {
    ...
    if (idx === -1) {
        ...
        var m3 = '</section>\r\n\r\n<!-- Footer -->';
        idx = h.indexOf(m3);
        console.log('crlf marker idx:', idx);
    }
}
if (idx === -1) process.exit(1);

var insertPos = idx + '</section>'.length;
var newH = h.slice(0, insertPos) + colorsSection + '\n\n\n' + h.slice(insertPos);
...
console.log('\nkids:', kidsIdx, '\ndivider:', dividerIdx, '\ncolors:', colorsIdx, '\nfooter:', footerIdx);
console.log('Order (kids < divider < colors < footer):', kidsIdx < dividerIdx && dividerIdx < colorsIdx && colorsIdx < footerIdx);