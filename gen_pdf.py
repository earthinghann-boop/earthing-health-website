...
PDF_OUT = Path(r"C:\Users\18574\Desktop\Earthing_Catalog_Final.pdf")
...
MARGIN = 12 * mm
VIEWPORT_W = 1280
VIEWPORT_H = 800  # slightly less than full viewport to avoid clip issues
SCROLL_STEP = 700  # px per scroll
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        context = await browser.new_context(
            ...
            device_scale_factor=1,  # Keep it simple
        )
    ...
    for i, img in enumerate(screenshots):
        ...
        c.drawImage(
            ImageReader(img),
            MARGIN, PAGE_H - MARGIN - rendered_h,
            width=img_w_mm, height=rendered_h
        )
        if (i + 1) % 5 == 0:
